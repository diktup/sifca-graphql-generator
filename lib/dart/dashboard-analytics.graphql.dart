...
part 'dashboard-analytics.graphql.g.dart';
...
@JsonSerializable(explicitToJson: true)
class GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountryLayersType$LatLngType
    extends JsonSerializable with EquatableMixin {
  GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountryLayersType$LatLngType();

  factory GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountryLayersType$LatLngType.fromJson(
          Map<String, dynamic> json) =>
...
@JsonSerializable(explicitToJson: true)
class GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType$PictureType
    extends JsonSerializable with EquatableMixin {
  GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType$PictureType();

  factory GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType$PictureType.fromJson(
          Map<String, dynamic> json) =>
...
@JsonSerializable(explicitToJson: true)
class GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType
    extends JsonSerializable with EquatableMixin {
  GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType();

  factory GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType.fromJson(
          Map<String, dynamic> json) =>
...
class GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType
  ...
  late GetAnalyticsUserByCountry$Query$AnalyticsUsersByCountryType$AnalyticsUsersByCountrySegmentsType$CountryType
      country;
  ...
  @override
  List<Object?> get props => [country, impressions, conversions];
...
class GetAnalyticsSessionsByCountries$Query$AnalyticsSessionsByCountriesType
  ...
  late GetAnalyticsSessionsByCountries$Query$AnalyticsSessionsByCountriesType$CountryType
      country;
...
class GetAnalyticsAudienceMetrics$Query$AnalyticsAudienceMetricsType$AnalyticsAudienceMetricsChartType
  ...
  late List<String> conversions;

  late List<String> impressions;

  @override
  List<Object?> get props => [conversions, impressions];
