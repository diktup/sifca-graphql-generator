...
Map<String, dynamic> _$GetAnalyticsStats$Query$AnalyticsStatsTypeToJson(
    ...
    <String, dynamic>{
      ...
      'impressions': instance.impressions?.toJson(),
...
Map<String, dynamic>
    _$GetAnalyticsAudienceMetrics$Query$AnalyticsAudienceMetricsTypeToJson(
            GetAnalyticsAudienceMetrics$Query$AnalyticsAudienceMetricsType
                instance) =>
        <String, dynamic>{
          'avgSession': instance.avgSession?.toJson(),
...
Map<String,
    dynamic> _$GetAnalyticsUsersByDevice$Query$AnalyticsUsersByDeviceTypeToJson(
    ...
    <String, dynamic>{
      ...
      'unknown': instance.unknown?.toJson(),
    };
