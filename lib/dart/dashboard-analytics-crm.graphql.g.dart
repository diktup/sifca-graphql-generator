...
part of 'dashboard-analytics-crm.graphql.dart';
...
GetCrmAnalyticsStats$Query$CrmAnalyticsStatsInfoType
    _$GetCrmAnalyticsStats$Query$CrmAnalyticsStatsInfoTypeFromJson(
        ...
        GetCrmAnalyticsStats$Query$CrmAnalyticsStatsInfoType()
          ...
          ..leadConversion = json['leadConversion'] as String?
          ..dailyIncome = json['dailyIncome'] as String?
          ..totalDeals = (json['totalDeals'] as num?)?.toDouble();
...
GetBoardCardsByCRMBoardWithFilterPaginated$Query
    _$GetBoardCardsByCRMBoardWithFilterPaginated$QueryFromJson(
            Map<String, dynamic> json) =>
        GetBoardCardsByCRMBoardWithFilterPaginated$Query()
          ..getBoardCardsByCRMBoardWithFilterPaginated =
              GetBoardCardsByCRMBoardWithFilterPaginated$Query$BoardCardPaginateType
                  .fromJson(json['getBoardCardsByCRMBoardWithFilterPaginated']
                      as Map<String, dynamic>);

Map<String, dynamic> _$GetBoardCardsByCRMBoardWithFilterPaginated$QueryToJson(
        GetBoardCardsByCRMBoardWithFilterPaginated$Query instance) =>
    <String, dynamic>{
      'getBoardCardsByCRMBoardWithFilterPaginated':
          instance.getBoardCardsByCRMBoardWithFilterPaginated.toJson(),
    };

CRMDashboardWithFilterInput _$CRMDashboardWithFilterInputFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CRMDashboardWithFilterInputToJson(
    CRMDashboardWithFilterInput instance) {
  final val = <String, dynamic>{
    'to': instance.to.toIso8601String(),
    'from': instance.from.toIso8601String(),
  };
...
GetCRMBoardCardProceduresWithFilter$Query
    _$GetCRMBoardCardProceduresWithFilter$QueryFromJson(
            Map<String, dynamic> json) =>
        GetCRMBoardCardProceduresWithFilter$Query()
          ..getCRMBoardCardProceduresWithFilter =
              GetCRMBoardCardProceduresWithFilter$Query$BoardCardProcedurePaginateType
                  .fromJson(json['getCRMBoardCardProceduresWithFilter']
                      as Map<String, dynamic>);

Map<String, dynamic> _$GetCRMBoardCardProceduresWithFilter$QueryToJson(
        GetCRMBoardCardProceduresWithFilter$Query instance) =>
    <String, dynamic>{
      'getCRMBoardCardProceduresWithFilter':
          instance.getCRMBoardCardProceduresWithFilter.toJson(),
    };

CRMDashboardWithTaskFilterInput _$CRMDashboardWithTaskFilterInputFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CRMDashboardWithTaskFilterInputToJson(
    CRMDashboardWithTaskFilterInput instance) {
  final val = <String, dynamic>{
    'to': instance.to.toIso8601String(),
    'from': instance.from.toIso8601String(),
  };
  ...
  writeNotNull('target', instance.target?.toJson());
  writeNotNull('task',
      instance.task?.map((e) => _$BoardCardProcedureEnumEnumMap[e]!).toList());
  return val;
}
...
GetBoardCardsByCRMBoardWithFilterPaginatedArguments
    _$GetBoardCardsByCRMBoardWithFilterPaginatedArgumentsFromJson(
            Map<String, dynamic> json) =>
        GetBoardCardsByCRMBoardWithFilterPaginatedArguments(
          input: CRMDashboardWithFilterInput.fromJson(
              json['input'] as Map<String, dynamic>),
...
Map<String, dynamic>
    _$GetBoardCardsByCRMBoardWithFilterPaginatedArgumentsToJson(
        GetBoardCardsByCRMBoardWithFilterPaginatedArguments instance) {
  final val = <String, dynamic>{
    'input': instance.input.toJson(),
  };
...
GetCRMBoardCardProceduresWithFilterArguments
    _$GetCRMBoardCardProceduresWithFilterArgumentsFromJson(
            Map<String, dynamic> json) =>
        GetCRMBoardCardProceduresWithFilterArguments(
          input: CRMDashboardWithTaskFilterInput.fromJson(
              json['input'] as Map<String, dynamic>),
          pagination: json['pagination'] == null
              ? null
              : PaginationInput.fromJson(
...
Map<String, dynamic> _$GetCRMBoardCardProceduresWithFilterArgumentsToJson(
    GetCRMBoardCardProceduresWithFilterArguments instance) {
  final val = <String, dynamic>{
    'input': instance.input.toJson(),
  };
