...
SalesDashboardInput _$SalesDashboardInputFromJson(Map<String, dynamic> json) =>
    SalesDashboardInput(
      to: DateTime.parse(json['to'] as String),
      from: DateTime.parse(json['from'] as String),
      target: json['target'] == null
...
Map<String, dynamic> _$SalesDashboardInputToJson(SalesDashboardInput instance) {
  final val = <String, dynamic>{
    'to': instance.to.toIso8601String(),
    'from': instance.from.toIso8601String(),
  };
...
GetSalesRevenueChartStatsArguments _$GetSalesRevenueChartStatsArgumentsFromJson(
    ...
    GetSalesRevenueChartStatsArguments(
      input: CRMDashboardInput.fromJson(json['input'] as Map<String, dynamic>),
    );
...
GetSalesTopCatalogueCategoriesArguments
    _$GetSalesTopCatalogueCategoriesArgumentsFromJson(
            Map<String, dynamic> json) =>
        GetSalesTopCatalogueCategoriesArguments(
          input: SalesDashboardInput.fromJson(
              json['input'] as Map<String, dynamic>),
        );
