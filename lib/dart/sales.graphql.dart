...
class GetSalesAnalyticsStats$Query$SalesAnalyticsStatsType
  ...
  List<Object?> get props =>
      [totalEarnings, orders, unpaidInvoices, partiallyPaidInvoices];
...
class GetSalesTopCatalogueCategories$Query$SalesAnalyticsTopCatalogueCategoriesType
  ...
  late GetSalesTopCatalogueCategories$Query$SalesAnalyticsTopCatalogueCategoriesType$CatalogueCategoryType
      category;
...
@JsonSerializable(explicitToJson: true)
class SalesDashboardInput extends JsonSerializable with EquatableMixin {
  SalesDashboardInput({
    required this.to,
    required this.from,
    this.target,
  ...
  factory SalesDashboardInput.fromJson(Map<String, dynamic> json) =>
      _$SalesDashboardInputFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() => _$SalesDashboardInputToJson(this);
}
...
class GetSalesTopCatalogueCategoriesArguments extends JsonSerializable
  ...
  late SalesDashboardInput input;
  ...
  OperationDefinitionNode(
    ...
    variableDefinitions: [
      VariableDefinitionNode(
        variable: VariableNode(name: NameNode(value: 'input')),
        type: NamedTypeNode(
          name: NameNode(value: 'SalesDashboardInput'),
          isNonNull: true,
        ),
        defaultValue: DefaultValueNode(value: null),
        directives: [],
